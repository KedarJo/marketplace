      ...
      <nav className="navbar fixed-top navbar-expand-md navbar-expand-lg navbar-light bg-light">
          <ul className="navbar-nav">
            <li className="nav-item active">
              <a href="#"
              className="nav-link"
              onClick={() => props.setCurrent('ApproveRequests')}>Approve Requests</a>
            </li>
            <li className="nav-item">
              <a href="#"
              className="nav-link"
              onClick={() => props.setCurrent('DisableStoreOwners')}>Disable Store Owners</a>
            </li>
            <li className="nav-item">
              <a href="#"
              className="nav-link"
              onClick={() => props.setCurrent('PayStore')}>Pay Stores</a>
            </li>
            <li className="nav-item">
              {props.admin
                ? <a href="#"
                  className="nav-link"
                  onClick={() => props.setCurrent('AddSuperuser')}>Add Superuser</a>
                : <a></a>
              }
            </li>
            <li className="nav-item">
              {props.admin
                ? <a href="#"
                  className="nav-link"
                  onClick={() => props.setCurrent('PauseOperation')}>Pause Operation</a>
                : <a></a>
              }
            </li>
          </ul>
